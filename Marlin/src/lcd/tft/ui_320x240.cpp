...
void MarlinUI::draw_status_screen() {
  ...
  if (TERN0(LCD_SHOW_E_TOTAL, printingIsActive())) {
      ...
      tft.add_text( 10, tft_string.vcenter(24), COLOR_AXIS_FRAME , "E");
    ...
    tft.add_text( 10, tft_string.vcenter(24), COLOR_AXIS_FRAME , "X");
    ...
    tft.add_text(127, tft_string.vcenter(24), COLOR_AXIS_FRAME , "Y");
  ...
  tft.add_text(219, tft_string.vcenter(24), COLOR_AXIS_FRAME , "Z");
  ...
  tft.add_text(tft_string.center(TFT_WIDTH), tft_string.vcenter(24), COLOR_STATUS_MESSAGE, tft_string);
    ...
    add_control(256, 130, menu_main, imgSettings);
      ...
      add_control(0, 130, menu_media, imgSD, cm && !pa, COLOR_SD_ENABLED, cm && pa ? COLOR_BUSY : COLOR_SD_DISABLED);
    #endif
  #endif
}
